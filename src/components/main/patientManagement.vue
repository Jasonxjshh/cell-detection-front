<template>
  <div class="container">
    ...
    <div>
      ...
      <el-button type="danger" :icon="Delete" @click="deleteUser(2)">
        <span>删除</span>
      </el-button>
    </div>
    ...
    <el-table ref="multipleTableRef" :data="tData.tableData" :table-layout="tableLayout"
      ...
      <el-table-column label="操作" header-align="center" align="center">
        <template #default="scope">
          ...
          <el-button type="danger" :icon="Delete" circle @click="deleteUser(2)" />
        </template>
      </el-table-column>
    </el-table>
    <el-dialog v-model="dialogFormVisible" :title="dialogTitle" width="500">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="dialogFormVisible = false, addorUpdateUser(2)">
            Confirm
          </el-button>
        </div>
      </template>
